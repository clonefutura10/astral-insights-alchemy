  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-800 text-white relative overflow-hidden">
      ...
      {isChatMode ? (
            ...
            <div ref={chatContainerRef} className="space-y-4 mb-6 max-h-[60vh] overflow-y-auto">
              {messages.map(message => (
                <div key={message.id} className={`flex ${message.sender === 'user' ? 'justify-end' : 'justify-start'}`}>
                  <div className={`rounded-2xl px-6 py-4 max-w-md ${
                    message.sender === 'user' 
              ...
              {isLoading && (
                <div className="flex justify-start">
                  <div className="bg-white/10 text-white border border-white/10 rounded-2xl px-6 py-4">
          ...
          <div className="max-w-4xl mx-auto w-full">
            <div className="flex space-x-4">
              <Input
                ...
                className="flex-1 bg-white/5 border-white/20 text-white placeholder-white/50 focus:border-blue-400 focus:ring-blue-400/20 h-12 text-base"
              />
              <Button 
                onClick={sendMessage}
                className="bg-blue-500/80 hover:bg-blue-600/80 text-white px-8 border-0 h-12"
              >
        ...
        // Landing Mode - Original Hero Section
